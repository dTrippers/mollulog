...
export default function Comment({ body, visibility, createdAt, sensei }: CommentProps) {
  const formattedTime = dayjs(createdAt).format("YYYY-MM-DD");
  return (
    <div className="flex gap-x-2 items-begin">
      <Link to={`/@${sensei.username}`} className="mt-2 shrink-0">
      ...
      <div className="flex-1">
        <div className="flex items-center gap-x-1">
          ...
          <span className="text-xs text-neutral-500 dark:text-neutral-400 ml-1">{formattedTime}</span>
