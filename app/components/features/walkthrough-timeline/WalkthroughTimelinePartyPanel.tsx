import { ArrowUturnLeftIcon, ArrowUturnRightIcon, PlusIcon } from "@heroicons/react/24/outline";
  ...
  return (
    <PanelBody>
        ...
        {parties.length === 0 ? (
          ...
          parties.map((party, index) => (
            <button
              ...
              type="button"
              className={cn(
                "flex min-h-10 w-full items-center gap-2 rounded-md px-2 py-1.5 text-left transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/30",
            ...
            >
              ...
              <span className="ml-auto flex min-w-0 -space-x-1.5" role="img" aria-label={`파티 ${index + 1} 편성 학생`}>
                {[...party.units]
      ...
      <div className="space-y-2 border-t border-border/70 pt-3">
        ...
        <Button
          type="submit"
          form="walkthrough-timeline-editor"
