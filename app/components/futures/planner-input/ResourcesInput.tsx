          ...
          <div className={`${vertical ? "flex flex-col gap-4" : "grid grid-cols-1 md:grid-cols-3 gap-4"}`}>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <NumberInput label="청휘석" value={resources.pyroxene} onChange={(value) => setResources((prev) => ({ ...prev, pyroxene: value }))} />
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="shrink-0 pt-1">
              ...
              <div className="flex-1 min-w-0">
                <NumberInput label="10회 모집 티켓" value={resources.tenTimeTicket} onChange={(value) => setResources((prev) => ({ ...prev, tenTimeTicket: value }))} />
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="shrink-0 pt-1">
              ...
              <div className="flex-1 min-w-0">
                <NumberInput label="1회 모집 티켓" value={resources.oneTimeTicket} onChange={(value) => setResources((prev) => ({ ...prev, oneTimeTicket: value }))} />
              </div>
            </div>
          </div>
        </div>
