...
export default function BottomSheet({ children, Icon, title, description, onClose }: BottomSheetProps) {
  ...
  return createPortal((
    <>
      <button
        type="button"
        className="fixed top-0 left-0 z-150 h-dvh w-screen bg-white/50 dark:bg-black/50"
        onClick={onClose}
        aria-label="바텀시트 닫기"
      />
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="p-2 lg:p-3 flex items-center justify-center bg-neutral-100 dark:bg-neutral-700 rounded-lg">
              <Icon className="size-5 lg:size-6 text-neutral-600 dark:text-neutral-400" strokeWidth={2} />
            </div>
            <div>
