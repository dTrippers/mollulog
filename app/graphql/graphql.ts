...
export type PyroxenePlannerContentsQuery = { __typename?: 'Query', contents: { __typename?: 'ContentInterfaceConnection', nodes: Array<{ __typename: 'Event', uid: string, name: string, since: Date, until: Date, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, student: { __typename?: 'Student', uid: string, initialTier: number } | null }> } | { __typename: 'Raid', type: RaidTypeEnum, uid: string, name: string, since: Date, until: Date }> } };
...
export type PickupEventsQuery = { __typename?: 'Query', events: { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'Event', uid: string, name: string, since: Date, until: Date, type: EventTypeEnum, rerun: boolean, pickups: Array<{ __typename?: 'Pickup', studentName: string, type: PickupTypeEnum, student: { __typename?: 'Student', uid: string } | null }> }> } };
