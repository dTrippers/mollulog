...
import { getAllRaidSchedules, applyTimelineDateFallback } from "~/models/raid";
...
export const loader = async ({ params, context, request }: LoaderFunctionArgs) => {
  ...
  const allRaids = await getAllRaidSchedules(env).then((raids) => applyTimelineDateFallback(env, raids));
